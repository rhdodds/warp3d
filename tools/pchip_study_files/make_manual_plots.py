...
#
 plt.plot( x[1:], y[1:],
       linestyle=lines(solid), markersize=symbsize, marker=symbols(1),
...
#
 ...
 xvals =  zeros( [15], float64 )
 yvals =  zeros( [15], float64 )
 xvals[1] = x[1]
 yvals[1] = delta[1]
 xvals[2] = x[2]
 yvals[2] = delta[1]
 ...
 xvals[11] = x[6]
 yvals[11] = delta[6]
 plt.plot( xvals[1:11], yvals[1:11],
       linestyle=lines(solid), markersize=symbsize, marker=symbols(0),
       color=colors(red),label="Segmental H'" )
