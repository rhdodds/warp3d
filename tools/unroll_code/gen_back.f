...
c          code of the ebksub subroutine. The basic operation of the 
c          generated code is to first gather the right hand side vector
c          for an element, to do back substution with a triangular matrix,
