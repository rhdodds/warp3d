...
#      ==========================
#
#      check results for test_69_PPR_patch_shear
#
$inputfile = 'test_69_PPR_patch_shear_out';
...
#
find_line( 1, "   newton convergence tests step:     160 iteration:   4 " );
find_line( 1, " -------   --------  " );
...
print "   ... comparison value:       0.248087E-01\n";
print "   ... value from output file: ", "$parts[3]\n";
print "   ... done\n";
close infile;
exit;
#
