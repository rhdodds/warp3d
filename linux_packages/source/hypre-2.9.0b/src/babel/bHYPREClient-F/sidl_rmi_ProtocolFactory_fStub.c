 ...
 * Revision:      @(#) $Id: sidl_rmi_ProtocolFactory_fStub.c,v 1.29 2007/09/27 19:56:36 painter Exp $
...
)
{
  ...
  struct sidl_BaseInterface__object* _proxy_exception = NULL;
  _proxy_prefix =
    sidl_copy_fortran_str(SIDL_F77_STR(prefix),(ptrdiff_t)
      SIDL_F77_STR_LEN(prefix));
  _proxy_typeName =
    sidl_copy_fortran_str(SIDL_F77_STR(typeName),(ptrdiff_t)
