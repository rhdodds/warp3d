! 
! File:          sidl_rmi_Invocation.F90
! Symbol:        sidl.rmi.Invocation-v0.9.15
! Symbol Type:   interface
! Babel Version: 1.0.0
! Release:       $Name: V2-9-0b $
! Revision:      @(#) $Id: sidl_rmi_Invocation.F90,v 1.1 2007/02/06 01:23:11 painter Exp $
...
module sidl_rmi_Invocation
  ...
  interface cast
    ...
    private :: invokeMethod_s


  interface invokeMethod
    module procedure invokeMethod_s
  end interface
    private :: invokeNonblocking_s


  interface invokeNonblocking
    module procedure invokeNonblocking_s
  end interface
    private :: invokeOneWay_s


  interface invokeOneWay
    module procedure invokeOneWay_s
  end interface
  private :: rConnect_s
  interface rConnect
...
contains
  ...
  recursive subroutine invokeMethod_s(self, retval, exception)
    implicit none
    !  in sidl.rmi.Invocation self
    type(sidl_rmi_Invocation_t) , intent(in) :: self
    !  out sidl.rmi.Response retval
    type(sidl_rmi_Response_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_Invocation_invokeMethod_m
    call sidl_rmi_Invocation_invokeMethod_m(self, retval, exception)

  end subroutine invokeMethod_s


  recursive subroutine invokeNonblocking_s(self, retval, exception)
    implicit none
    !  in sidl.rmi.Invocation self
    type(sidl_rmi_Invocation_t) , intent(in) :: self
    !  out sidl.rmi.Ticket retval
    type(sidl_rmi_Ticket_t) , intent(out) :: retval
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_Invocation_invokeNonblocking_m
    call sidl_rmi_Invocation_invokeNonblocking_m(self, retval, exception)

  end subroutine invokeNonblocking_s


  recursive subroutine invokeOneWay_s(self, exception)
    implicit none
    !  in sidl.rmi.Invocation self
    type(sidl_rmi_Invocation_t) , intent(in) :: self
    !  out sidl.BaseInterface exception
    ...
    external sidl_rmi_Invocation_invokeOneWay_m
    call sidl_rmi_Invocation_invokeOneWay_m(self, exception)

  end subroutine invokeOneWay_s


  recursive subroutine rConnect_s(self, url, exception)
    implicit none
    !  out sidl.rmi.Invocation self
    type(sidl_rmi_Invocation_t) , intent(out) :: self
    !  in string url
    character (len=*) , intent(in) :: url
    !  out sidl.BaseInterface exception
    type(sidl_BaseInterface_t) , intent(out) :: exception

    external sidl_rmi_Invocation_rConnect_m
    call sidl_rmi_Invocation_rConnect_m(self, url, exception)
  ...
  recursive subroutine addRef_s(self, exception)
    ...
    external sidl_rmi_Invocation_addRef_m
    call sidl_rmi_Invocation_addRef_m(self, exception)
  ...
  recursive subroutine deleteRef_s(self, exception)
    ...
    external sidl_rmi_Invocation_deleteRef_m
    call sidl_rmi_Invocation_deleteRef_m(self, exception)
  ...
  recursive subroutine isSame_s(self, iobj, retval, exception)
    ...
    external sidl_rmi_Invocation_isSame_m
    call sidl_rmi_Invocation_isSame_m(self, iobj, retval, exception)
  ...
  recursive subroutine isType_s(self, name, retval, exception)
    ...
    external sidl_rmi_Invocation_isType_m
    call sidl_rmi_Invocation_isType_m(self, name, retval, exception)
  ...
  recursive subroutine getClassInfo_s(self, retval, exception)
    ...
    external sidl_rmi_Invocation_getClassInfo_m
    call sidl_rmi_Invocation_getClassInfo_m(self, retval, exception)
  ...
  recursive subroutine packBool_s(self, key, value, exception)
    ...
    external sidl_rmi_Invocation_packBool_m
    call sidl_rmi_Invocation_packBool_m(self, key, value, exception)
  ...
  recursive subroutine packChar_s(self, key, value, exception)
    ...
    external sidl_rmi_Invocation_packChar_m
    call sidl_rmi_Invocation_packChar_m(self, key, value, exception)
  ...
  recursive subroutine packInt_s(self, key, value, exception)
    ...
    external sidl_rmi_Invocation_packInt_m
    call sidl_rmi_Invocation_packInt_m(self, key, value, exception)
  ...
  recursive subroutine packLong_s(self, key, value, exception)
    ...
    external sidl_rmi_Invocation_packLong_m
    call sidl_rmi_Invocation_packLong_m(self, key, value, exception)
  ...
  recursive subroutine packOpaque_s(self, key, value, exception)
    ...
    external sidl_rmi_Invocation_packOpaque_m
    call sidl_rmi_Invocation_packOpaque_m(self, key, value, exception)
  ...
  recursive subroutine packFloat_s(self, key, value, exception)
    ...
    external sidl_rmi_Invocation_packFloat_m
    call sidl_rmi_Invocation_packFloat_m(self, key, value, exception)
  ...
  recursive subroutine packDouble_s(self, key, value, exception)
    ...
    external sidl_rmi_Invocation_packDouble_m
    call sidl_rmi_Invocation_packDouble_m(self, key, value, exception)
  ...
  recursive subroutine packFcomplex_s(self, key, value, exception)
    ...
    external sidl_rmi_Invocation_packFcomplex_m
    call sidl_rmi_Invocation_packFcomplex_m(self, key, value, exception)
  ...
  recursive subroutine packDcomplex_s(self, key, value, exception)
    ...
    external sidl_rmi_Invocation_packDcomplex_m
    call sidl_rmi_Invocation_packDcomplex_m(self, key, value, exception)
  ...
  recursive subroutine packString_s(self, key, value, exception)
    ...
    external sidl_rmi_Invocation_packString_m
    call sidl_rmi_Invocation_packString_m(self, key, value, exception)
  ...
  recursive subroutine packSerializable_s(self, key, value, exception)
    ...
    external sidl_rmi_Invocation_packSerializable_m
    call sidl_rmi_Invocation_packSerializable_m(self, key, value, exception)
  ...
  recursive subroutine packBoolArray_s(self, key, value, ordering, dimen,      &
    ...
    external sidl_rmi_Invocation_packBoolArray_m
    call sidl_rmi_Invocation_packBoolArray_m(self, key, value, ordering,       &
  ...
  recursive subroutine packCharArray_s(self, key, value, ordering, dimen,      &
    ...
    external sidl_rmi_Invocation_packCharArray_m
    call sidl_rmi_Invocation_packCharArray_m(self, key, value, ordering,       &
      dimen, reuse_array, exception)
  ...
  recursive subroutine packIntArray_s(self, key, value, ordering, dimen,       &
    ...
    external sidl_rmi_Invocation_packIntArray_m
    call sidl_rmi_Invocation_packIntArray_m(self, key, value, ordering, dimen, &
      reuse_array, exception)
  ...
  recursive subroutine packLongArray_s(self, key, value, ordering, dimen,      &
    ...
    external sidl_rmi_Invocation_packLongArray_m
    call sidl_rmi_Invocation_packLongArray_m(self, key, value, ordering,       &
      dimen, reuse_array, exception)
  ...
  recursive subroutine packOpaqueArray_s(self, key, value, ordering, dimen,    &
    ...
    external sidl_rmi_Invocation_packOpaqueArray_m
    call sidl_rmi_Invocation_packOpaqueArray_m(self, key, value, ordering,     &
      dimen, reuse_array, exception)
  ...
  recursive subroutine packFloatArray_s(self, key, value, ordering, dimen,     &
    ...
    external sidl_rmi_Invocation_packFloatArray_m
    call sidl_rmi_Invocation_packFloatArray_m(self, key, value, ordering,      &
      dimen, reuse_array, exception)
  ...
  recursive subroutine packDoubleArray_s(self, key, value, ordering, dimen,    &
    ...
    external sidl_rmi_Invocation_packDoubleArray_m
    call sidl_rmi_Invocation_packDoubleArray_m(self, key, value, ordering,     &
      dimen, reuse_array, exception)
  ...
  recursive subroutine packFcomplexArray_s(self, key, value, ordering, dimen,  &
    ...
    external sidl_rmi_Invocation_packFcomplexArray_m
    call sidl_rmi_Invocation_packFcomplexArray_m(self, key, value, ordering,   &
      dimen, reuse_array, exception)
  ...
  recursive subroutine packDcomplexArray_s(self, key, value, ordering, dimen,  &
    ...
    external sidl_rmi_Invocation_packDcomplexArray_m
    call sidl_rmi_Invocation_packDcomplexArray_m(self, key, value, ordering,   &
      dimen, reuse_array, exception)
  ...
  recursive subroutine packStringArray_s(self, key, value, ordering, dimen,    &
    ...
    external sidl_rmi_Invocation_packStringArray_m
    call sidl_rmi_Invocation_packStringArray_m(self, key, value, ordering,     &
      dimen, reuse_array, exception)
  ...
  recursive subroutine packGenericArray_s(self, key, value, reuse_array,       &
    ...
    external sidl_rmi_Invocation_packGenericArray_m
    call sidl_rmi_Invocation_packGenericArray_m(self, key, value, reuse_array, &
      exception)
  ...
  recursive subroutine packSerializableArray_s(self, key, value, ordering,     &
    ...
    external sidl_rmi_Invocation_packSerializableArray_m
    call sidl_rmi_Invocation_packSerializableArray_m(self, key, value,         &
      ordering, dimen, reuse_array, exception)

  end subroutine packSerializableArray_s

  ! 
  ! Static function to cast from sidl.rmi.Invocation
  ! to sidl.BaseInterface.
  ! 

  subroutine cast_0(oldType, newType, exception)
    implicit none
    type(sidl_rmi_Invocation_t), intent(in) :: oldType
  ...
  ! to sidl.rmi.Invocation.
  ! 

  subroutine cast_1(oldType, newType, exception)
    implicit none
    type(sidl_BaseInterface_t), intent(in) :: oldType
    type(sidl_rmi_Invocation_t), intent(out) :: newType
    type(sidl_BaseInterface_t), intent(out) :: exception
    external sidl_rmi_Invocation__cast_m

    call sidl_rmi_Invocation__cast_m(oldType, newType, exception)
  ...
  recursive subroutine exec_s(self, methodName, inArgs, outArgs, exception)
    ...
    external sidl_rmi_Invocation__exec_m
    call sidl_rmi_Invocation__exec_m(self, methodName, inArgs, outArgs,        &
      exception)
  ...
  recursive subroutine getURL_s(self, retval, exception)
    ...
    external sidl_rmi_Invocation__getURL_m
    call sidl_rmi_Invocation__getURL_m(self, retval, exception)
  ...
  recursive subroutine isRemote_s(self, retval, exception)
    ...
    external sidl_rmi_Invocation__isRemote_m
    call sidl_rmi_Invocation__isRemote_m(self, retval, exception)
  ...
  recursive subroutine isLocal_s(self, retval, exception)
    ...
    external sidl_rmi_Invocation__isLocal_m
    call sidl_rmi_Invocation__isLocal_m(self, retval, exception)
  ...
  recursive subroutine set_hooks_s(self, on, exception)
    ...
    external sidl_rmi_Invocation__set_hooks_m
    call sidl_rmi_Invocation__set_hooks_m(self, on, exception)

  end subroutine set_hooks_s
  logical function is_null_s(ext)
    type(sidl_rmi_Invocation_t), intent(in) :: ext
  ...
  subroutine set_null_s(ext)
    type(sidl_rmi_Invocation_t), intent(out) :: ext
    ext%d_ior = 0
  end subroutine set_null_s


end module sidl_rmi_Invocation

module sidl_rmi_Invocation_array
  use sidl
  use sidl_rmi_Invocation_type
  use sidl_array_type
  ...
  private :: &
    castsidl_rmi_Invoca5y1ipqwsyc_p, &
    castsidl_rmi_Invoca51d864af1w_p, &
    castsidl_rmi_Invocawtdcsok3mz_p, &
    castsidl_rmi_Invocafylf_5k53r_p, &
    castsidl_rmi_Invocaq8ejg28noo_p, &
    castsidl_rmi_Invoca_jlmravytc_p, &
    castsidl_rmi_Invoca23zk6lvijg_p
interface cast
  module procedure &
    castsidl_rmi_Invoca5y1ipqwsyc_p, &
    castsidl_rmi_Invoca51d864af1w_p, &
...
contains
  ...
  subroutine createCol1_p(lower, upper, array)
    ...
    type(sidl_rmi_Invocation_1d), intent(out) :: array
    external In_ary_createCol3qdq7spe9ev5w_m
    call In_ary_createCol3qdq7spe9ev5w_m(1, lower, upper, array)
  ...
  subroutine createRow1_p(lower, upper, array)
    ...
    integer (kind=sidl_int), dimension(1), intent(in) :: upper
    type(sidl_rmi_Invocation_1d), intent(out) :: array
    external In_ary_createRownd0omqsr6wm_j_m
    call In_ary_createRownd0omqsr6wm_j_m(1, lower, upper, array)
  end subroutine createRow1_p

  subroutine create1d1_p(len, array)
    integer (kind=sidl_int), intent(in) :: len
    type(sidl_rmi_Invocation_1d), intent(out) :: array
    external Inv_ary_create1dglowj_1b4k4gm_m
    call Inv_ary_create1dglowj_1b4k4gm_m(len, array)
  end subroutine create1d1_p

  subroutine copy1_p(src, dest)
    type(sidl_rmi_Invocation_1d), intent(in) :: src
    type(sidl_rmi_Invocation_1d), intent(in) :: dest
    external Invocat_ary_copy6is8v0fon1aju_m
    call Invocat_ary_copy6is8v0fon1aju_m(src, dest)
  end subroutine copy1_p

  subroutine ensure1_p(src, dim, ordering, result)
    type(sidl_rmi_Invocation_1d), intent(in)  :: src
    type(sidl_rmi_Invocation_1d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Invoc_ary_ensurepwvlq28_wpqdd_m
    call Invoc_ary_ensurepwvlq28_wpqdd_m(src, 1, ordering, result)
  ...
  subroutine slice11_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    external Invoca_ary_slicee8_5r91_55rr4_m
    call Invoca_ary_slicee8_5r91_55rr4_m(src, 1, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice11_p

  subroutine getg1_p(array, index, value)
    type(sidl_rmi_Invocation_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_rmi_Invocation_t), intent(out) :: value
    external Invocati_ary_getnz0rlly30h670_m
    call Invocati_ary_getnz0rlly30h670_m(array, index, value)
  end subroutine getg1_p

  subroutine setg1_p(array, index, value)
    type(sidl_rmi_Invocation_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in), dimension(1) :: index
    type(sidl_rmi_Invocation_t), intent(in) :: value
    external Invocati_ary_set03tkkco7ntm8d_m
    call Invocati_ary_set03tkkco7ntm8d_m(array, index, value)
  ...
  subroutine get1_p(array, &
    ...
    type(sidl_rmi_Invocation_t), intent(out) :: value
    external Invocat_ary_get1ne2y9vvtw7655_m
    call Invocat_ary_get1ne2y9vvtw7655_m(array, &
      i1, &
      value)
  ...
  subroutine set1_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i1
    type(sidl_rmi_Invocation_t), intent(in) :: value
    external Invocat_ary_set12tw2bmq3r9i3a_m
    call Invocat_ary_set12tw2bmq3r9i3a_m(array, &
      i1, &
      value)
  ...
  subroutine smartCopy1_p(src, dest)
    type(sidl_rmi_Invocation_1d), intent(in) :: src
    type(sidl_rmi_Invocation_1d), intent(out) :: dest
    integer(sidl_int) :: dim
    external In_ary_smartCopyhfbxfo3asgjc3_m
    dim = 1
    call In_ary_smartCopyhfbxfo3asgjc3_m(src, 1, dest)
  end subroutine smartCopy1_p

  logical function  isColumnOrder1_p(array)
    type(sidl_rmi_Invocation_1d), intent(in)  :: array
    external ary_isColumnOrderro74_61krayb_m
    call ary_isColumnOrderro74_61krayb_m(array, isColumnOrder1_p)
  end function isColumnOrder1_p

  logical function  isRowOrder1_p(array)
    type(sidl_rmi_Invocation_1d), intent(in)  :: array
    external I_ary_isRowOrderwrkl6jm2zx45k_m
    call I_ary_isRowOrderwrkl6jm2zx45k_m(array, isRowOrder1_p)
  end function isRowOrder1_p

  integer (kind=sidl_int) function  dimen1_p(array)
    type(sidl_rmi_Invocation_1d), intent(in)  :: array
    external Invoca_ary_dimene7j0yj1dohhyb_m
    call Invoca_ary_dimene7j0yj1dohhyb_m(array, dimen1_p)
  end function dimen1_p

  integer (kind=sidl_int) function  stride1_p(array, index)
    type(sidl_rmi_Invocation_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Invoc_ary_stride_osjbpdtqgbr3_m
    call Invoc_ary_stride_osjbpdtqgbr3_m(array, index, stride1_p)
  end function stride1_p

  integer (kind=sidl_int) function  lower1_p(array, index)
    type(sidl_rmi_Invocation_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Invoca_ary_lowerpvxk5v7667bo8_m
    call Invoca_ary_lowerpvxk5v7667bo8_m(array, index, lower1_p)
  end function lower1_p

  integer (kind=sidl_int) function  upper1_p(array, index)
    type(sidl_rmi_Invocation_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Invoca_ary_upperic2bd00apk096_m
    call Invoca_ary_upperic2bd00apk096_m(array, index, upper1_p)
  end function upper1_p

  integer (kind=sidl_int) function  length1_p(array, index)
    type(sidl_rmi_Invocation_1d), intent(in)  :: array
    integer (kind=sidl_int), intent(in) :: index
    external Invoc_ary_lengthtioowgh6jirws_m
    call Invoc_ary_lengthtioowgh6jirws_m(array, index, length1_p)
  end function length1_p

  subroutine  addRef1_p(array)
    type(sidl_rmi_Invocation_1d), intent(in)  :: array
    external Invoc_ary_addRefhz_o9lx83fwae_m
    call Invoc_ary_addRefhz_o9lx83fwae_m(array)
  end subroutine addRef1_p

  subroutine  deleteRef1_p(array)
    type(sidl_rmi_Invocation_1d), intent(in)  :: array
    external In_ary_deleteRefe111bke1r_3c2_m
    call In_ary_deleteRefe111bke1r_3c2_m(array)
  ...
  subroutine createCol2_p(lower, upper, array)
    ...
    type(sidl_rmi_Invocation_2d), intent(out) :: array
    external In_ary_createCol3qdq7spe9ev5w_m
    call In_ary_createCol3qdq7spe9ev5w_m(2, lower, upper, array)
  ...
  subroutine createRow2_p(lower, upper, array)
    ...
    type(sidl_rmi_Invocation_2d), intent(out) :: array
    external In_ary_createRownd0omqsr6wm_j_m
    call In_ary_createRownd0omqsr6wm_j_m(2, lower, upper, array)
  end subroutine createRow2_p

  subroutine create2dCol2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_rmi_Invocation_2d), intent(out) :: array
    external ary_create2dColyqu07chf2_36ka_m
    call ary_create2dColyqu07chf2_36ka_m(m, n, array)
  end subroutine create2dCol2_p

  subroutine create2dRow2_p(m, n, array)
    integer (kind=sidl_int), intent(in) :: m, n
    type(sidl_rmi_Invocation_2d), intent(out) :: array
    external ary_create2dRowalxj8afyrby1ex_m
    call ary_create2dRowalxj8afyrby1ex_m(m, n, array)
  end subroutine create2dRow2_p

  subroutine copy2_p(src, dest)
    type(sidl_rmi_Invocation_2d), intent(in) :: src
    type(sidl_rmi_Invocation_2d), intent(in) :: dest
    external Invocat_ary_copy6is8v0fon1aju_m
    call Invocat_ary_copy6is8v0fon1aju_m(src, dest)
  ...
  subroutine ensure2_p(src, dim, ordering, result)
    type(sidl_rmi_Invocation_2d), intent(in)  :: src
    type(sidl_rmi_Invocation_2d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Invoc_ary_ensurepwvlq28_wpqdd_m
    call Invoc_ary_ensurepwvlq28_wpqdd_m(src, 2, ordering, result)
  ...
  subroutine slice22_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Invoca_ary_slicee8_5r91_55rr4_m
    call Invoca_ary_slicee8_5r91_55rr4_m(src, 2, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice22_p

  subroutine getg2_p(array, index, value)
    type(sidl_rmi_Invocation_2d), intent(in)  :: array
  ...
  subroutine get2_p(array, &
    ...
    type(sidl_rmi_Invocation_t), intent(out) :: value
    external Invocat_ary_get2dmqnh56l3ncxf_m
    call Invocat_ary_get2dmqnh56l3ncxf_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine set2_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i2
    type(sidl_rmi_Invocation_t), intent(in) :: value
    external Invocat_ary_set2a8eob10dv25zy_m
    call Invocat_ary_set2a8eob10dv25zy_m(array, &
      i1, &
      i2, &
      value)
  ...
  subroutine smartCopy2_p(src, dest)
    type(sidl_rmi_Invocation_2d), intent(in) :: src
    type(sidl_rmi_Invocation_2d), intent(out) :: dest
    integer(sidl_int) :: dim
    external In_ary_smartCopyhfbxfo3asgjc3_m
    dim = 2
    call In_ary_smartCopyhfbxfo3asgjc3_m(src, 2, dest)
  end subroutine smartCopy2_p

  logical function  isColumnOrder2_p(array)
    type(sidl_rmi_Invocation_2d), intent(in)  :: array
    external ary_isColumnOrderro74_61krayb_m
    call ary_isColumnOrderro74_61krayb_m(array, isColumnOrder2_p)
  end function isColumnOrder2_p

  logical function  isRowOrder2_p(array)
    type(sidl_rmi_Invocation_2d), intent(in)  :: array
    external I_ary_isRowOrderwrkl6jm2zx45k_m
    call I_ary_isRowOrderwrkl6jm2zx45k_m(array, isRowOrder2_p)
  end function isRowOrder2_p

  integer (kind=sidl_int) function  dimen2_p(array)
    type(sidl_rmi_Invocation_2d), intent(in)  :: array
    external Invoca_ary_dimene7j0yj1dohhyb_m
    call Invoca_ary_dimene7j0yj1dohhyb_m(array, dimen2_p)
  ...
  integer (kind=sidl_int) function  stride2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoc_ary_stride_osjbpdtqgbr3_m
    call Invoc_ary_stride_osjbpdtqgbr3_m(array, index, stride2_p)
  ...
  integer (kind=sidl_int) function  lower2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoca_ary_lowerpvxk5v7667bo8_m
    call Invoca_ary_lowerpvxk5v7667bo8_m(array, index, lower2_p)
  ...
  integer (kind=sidl_int) function  upper2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoca_ary_upperic2bd00apk096_m
    call Invoca_ary_upperic2bd00apk096_m(array, index, upper2_p)
  ...
  integer (kind=sidl_int) function  length2_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoc_ary_lengthtioowgh6jirws_m
    call Invoc_ary_lengthtioowgh6jirws_m(array, index, length2_p)
  ...
  subroutine createCol3_p(lower, upper, array)
    ...
    type(sidl_rmi_Invocation_3d), intent(out) :: array
    external In_ary_createCol3qdq7spe9ev5w_m
    call In_ary_createCol3qdq7spe9ev5w_m(3, lower, upper, array)
  ...
  subroutine createRow3_p(lower, upper, array)
    ...
    type(sidl_rmi_Invocation_3d), intent(out) :: array
    external In_ary_createRownd0omqsr6wm_j_m
    call In_ary_createRownd0omqsr6wm_j_m(3, lower, upper, array)
  end subroutine createRow3_p

  subroutine copy3_p(src, dest)
    type(sidl_rmi_Invocation_3d), intent(in) :: src
    type(sidl_rmi_Invocation_3d), intent(in) :: dest
    external Invocat_ary_copy6is8v0fon1aju_m
    call Invocat_ary_copy6is8v0fon1aju_m(src, dest)
  ...
  subroutine ensure3_p(src, dim, ordering, result)
    type(sidl_rmi_Invocation_3d), intent(in)  :: src
    type(sidl_rmi_Invocation_3d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Invoc_ary_ensurepwvlq28_wpqdd_m
    call Invoc_ary_ensurepwvlq28_wpqdd_m(src, 3, ordering, result)
  ...
  subroutine slice33_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Invoca_ary_slicee8_5r91_55rr4_m
    call Invoca_ary_slicee8_5r91_55rr4_m(src, 3, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice33_p

  subroutine getg3_p(array, index, value)
    type(sidl_rmi_Invocation_3d), intent(in)  :: array
  ...
  subroutine get3_p(array, &
    ...
    type(sidl_rmi_Invocation_t), intent(out) :: value
    external Invocat_ary_get3xfht1f45ne30p_m
    call Invocat_ary_get3xfht1f45ne30p_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine set3_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i3
    type(sidl_rmi_Invocation_t), intent(in) :: value
    external Invocat_ary_set37swm0p245npzo_m
    call Invocat_ary_set37swm0p245npzo_m(array, &
      i1, &
      i2, &
      i3, &
      value)
  ...
  subroutine smartCopy3_p(src, dest)
    type(sidl_rmi_Invocation_3d), intent(in) :: src
    type(sidl_rmi_Invocation_3d), intent(out) :: dest
    integer(sidl_int) :: dim
    external In_ary_smartCopyhfbxfo3asgjc3_m
    dim = 3
    call In_ary_smartCopyhfbxfo3asgjc3_m(src, 3, dest)
  end subroutine smartCopy3_p

  logical function  isColumnOrder3_p(array)
    type(sidl_rmi_Invocation_3d), intent(in)  :: array
    external ary_isColumnOrderro74_61krayb_m
    call ary_isColumnOrderro74_61krayb_m(array, isColumnOrder3_p)
  end function isColumnOrder3_p

  logical function  isRowOrder3_p(array)
    type(sidl_rmi_Invocation_3d), intent(in)  :: array
    external I_ary_isRowOrderwrkl6jm2zx45k_m
    call I_ary_isRowOrderwrkl6jm2zx45k_m(array, isRowOrder3_p)
  end function isRowOrder3_p

  integer (kind=sidl_int) function  dimen3_p(array)
    type(sidl_rmi_Invocation_3d), intent(in)  :: array
    external Invoca_ary_dimene7j0yj1dohhyb_m
    call Invoca_ary_dimene7j0yj1dohhyb_m(array, dimen3_p)
  ...
  integer (kind=sidl_int) function  stride3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoc_ary_stride_osjbpdtqgbr3_m
    call Invoc_ary_stride_osjbpdtqgbr3_m(array, index, stride3_p)
  ...
  integer (kind=sidl_int) function  lower3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoca_ary_lowerpvxk5v7667bo8_m
    call Invoca_ary_lowerpvxk5v7667bo8_m(array, index, lower3_p)
  ...
  integer (kind=sidl_int) function  upper3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoca_ary_upperic2bd00apk096_m
    call Invoca_ary_upperic2bd00apk096_m(array, index, upper3_p)
  ...
  integer (kind=sidl_int) function  length3_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoc_ary_lengthtioowgh6jirws_m
    call Invoc_ary_lengthtioowgh6jirws_m(array, index, length3_p)
  ...
  subroutine createCol4_p(lower, upper, array)
    ...
    type(sidl_rmi_Invocation_4d), intent(out) :: array
    external In_ary_createCol3qdq7spe9ev5w_m
    call In_ary_createCol3qdq7spe9ev5w_m(4, lower, upper, array)
  ...
  subroutine createRow4_p(lower, upper, array)
    ...
    type(sidl_rmi_Invocation_4d), intent(out) :: array
    external In_ary_createRownd0omqsr6wm_j_m
    call In_ary_createRownd0omqsr6wm_j_m(4, lower, upper, array)
  end subroutine createRow4_p

  subroutine copy4_p(src, dest)
    type(sidl_rmi_Invocation_4d), intent(in) :: src
    type(sidl_rmi_Invocation_4d), intent(in) :: dest
    external Invocat_ary_copy6is8v0fon1aju_m
    call Invocat_ary_copy6is8v0fon1aju_m(src, dest)
  ...
  subroutine ensure4_p(src, dim, ordering, result)
    type(sidl_rmi_Invocation_4d), intent(in)  :: src
    type(sidl_rmi_Invocation_4d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Invoc_ary_ensurepwvlq28_wpqdd_m
    call Invoc_ary_ensurepwvlq28_wpqdd_m(src, 4, ordering, result)
  ...
  subroutine slice44_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Invoca_ary_slicee8_5r91_55rr4_m
    call Invoca_ary_slicee8_5r91_55rr4_m(src, 4, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice44_p

  subroutine getg4_p(array, index, value)
    type(sidl_rmi_Invocation_4d), intent(in)  :: array
  ...
  subroutine get4_p(array, &
    ...
    type(sidl_rmi_Invocation_t), intent(out) :: value
    external Invocat_ary_get4lievo07wx0v8w_m
    call Invocat_ary_get4lievo07wx0v8w_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set4_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i4
    type(sidl_rmi_Invocation_t), intent(in) :: value
    external Invocat_ary_set4k_loc_83rjlra_m
    call Invocat_ary_set4k_loc_83rjlra_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy4_p(src, dest)
    type(sidl_rmi_Invocation_4d), intent(in) :: src
    type(sidl_rmi_Invocation_4d), intent(out) :: dest
    integer(sidl_int) :: dim
    external In_ary_smartCopyhfbxfo3asgjc3_m
    dim = 4
    call In_ary_smartCopyhfbxfo3asgjc3_m(src, 4, dest)
  end subroutine smartCopy4_p

  logical function  isColumnOrder4_p(array)
    type(sidl_rmi_Invocation_4d), intent(in)  :: array
    external ary_isColumnOrderro74_61krayb_m
    call ary_isColumnOrderro74_61krayb_m(array, isColumnOrder4_p)
  end function isColumnOrder4_p

  logical function  isRowOrder4_p(array)
    type(sidl_rmi_Invocation_4d), intent(in)  :: array
    external I_ary_isRowOrderwrkl6jm2zx45k_m
    call I_ary_isRowOrderwrkl6jm2zx45k_m(array, isRowOrder4_p)
  end function isRowOrder4_p

  integer (kind=sidl_int) function  dimen4_p(array)
    type(sidl_rmi_Invocation_4d), intent(in)  :: array
    external Invoca_ary_dimene7j0yj1dohhyb_m
    call Invoca_ary_dimene7j0yj1dohhyb_m(array, dimen4_p)
  ...
  integer (kind=sidl_int) function  stride4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoc_ary_stride_osjbpdtqgbr3_m
    call Invoc_ary_stride_osjbpdtqgbr3_m(array, index, stride4_p)
  ...
  integer (kind=sidl_int) function  lower4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoca_ary_lowerpvxk5v7667bo8_m
    call Invoca_ary_lowerpvxk5v7667bo8_m(array, index, lower4_p)
  ...
  integer (kind=sidl_int) function  upper4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoca_ary_upperic2bd00apk096_m
    call Invoca_ary_upperic2bd00apk096_m(array, index, upper4_p)
  ...
  integer (kind=sidl_int) function  length4_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoc_ary_lengthtioowgh6jirws_m
    call Invoc_ary_lengthtioowgh6jirws_m(array, index, length4_p)
  ...
  subroutine createCol5_p(lower, upper, array)
    ...
    type(sidl_rmi_Invocation_5d), intent(out) :: array
    external In_ary_createCol3qdq7spe9ev5w_m
    call In_ary_createCol3qdq7spe9ev5w_m(5, lower, upper, array)
  ...
  subroutine createRow5_p(lower, upper, array)
    ...
    type(sidl_rmi_Invocation_5d), intent(out) :: array
    external In_ary_createRownd0omqsr6wm_j_m
    call In_ary_createRownd0omqsr6wm_j_m(5, lower, upper, array)
  end subroutine createRow5_p

  subroutine copy5_p(src, dest)
    type(sidl_rmi_Invocation_5d), intent(in) :: src
    type(sidl_rmi_Invocation_5d), intent(in) :: dest
    external Invocat_ary_copy6is8v0fon1aju_m
    call Invocat_ary_copy6is8v0fon1aju_m(src, dest)
  ...
  subroutine ensure5_p(src, dim, ordering, result)
    type(sidl_rmi_Invocation_5d), intent(in)  :: src
    type(sidl_rmi_Invocation_5d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Invoc_ary_ensurepwvlq28_wpqdd_m
    call Invoc_ary_ensurepwvlq28_wpqdd_m(src, 5, ordering, result)
  ...
  subroutine slice55_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Invoca_ary_slicee8_5r91_55rr4_m
    call Invoca_ary_slicee8_5r91_55rr4_m(src, 5, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice55_p

  subroutine getg5_p(array, index, value)
    type(sidl_rmi_Invocation_5d), intent(in)  :: array
  ...
  subroutine get5_p(array, &
    ...
    type(sidl_rmi_Invocation_t), intent(out) :: value
    external Invocat_ary_get5rpzpz44u3rbxj_m
    call Invocat_ary_get5rpzpz44u3rbxj_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set5_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i5
    type(sidl_rmi_Invocation_t), intent(in) :: value
    external Invocat_ary_set5srq5xgh8sgel8_m
    call Invocat_ary_set5srq5xgh8sgel8_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy5_p(src, dest)
    type(sidl_rmi_Invocation_5d), intent(in) :: src
    type(sidl_rmi_Invocation_5d), intent(out) :: dest
    integer(sidl_int) :: dim
    external In_ary_smartCopyhfbxfo3asgjc3_m
    dim = 5
    call In_ary_smartCopyhfbxfo3asgjc3_m(src, 5, dest)
  end subroutine smartCopy5_p

  logical function  isColumnOrder5_p(array)
    type(sidl_rmi_Invocation_5d), intent(in)  :: array
    external ary_isColumnOrderro74_61krayb_m
    call ary_isColumnOrderro74_61krayb_m(array, isColumnOrder5_p)
  end function isColumnOrder5_p

  logical function  isRowOrder5_p(array)
    type(sidl_rmi_Invocation_5d), intent(in)  :: array
    external I_ary_isRowOrderwrkl6jm2zx45k_m
    call I_ary_isRowOrderwrkl6jm2zx45k_m(array, isRowOrder5_p)
  end function isRowOrder5_p

  integer (kind=sidl_int) function  dimen5_p(array)
    type(sidl_rmi_Invocation_5d), intent(in)  :: array
    external Invoca_ary_dimene7j0yj1dohhyb_m
    call Invoca_ary_dimene7j0yj1dohhyb_m(array, dimen5_p)
  ...
  integer (kind=sidl_int) function  stride5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoc_ary_stride_osjbpdtqgbr3_m
    call Invoc_ary_stride_osjbpdtqgbr3_m(array, index, stride5_p)
  ...
  integer (kind=sidl_int) function  lower5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoca_ary_lowerpvxk5v7667bo8_m
    call Invoca_ary_lowerpvxk5v7667bo8_m(array, index, lower5_p)
  ...
  integer (kind=sidl_int) function  upper5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoca_ary_upperic2bd00apk096_m
    call Invoca_ary_upperic2bd00apk096_m(array, index, upper5_p)
  ...
  integer (kind=sidl_int) function  length5_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoc_ary_lengthtioowgh6jirws_m
    call Invoc_ary_lengthtioowgh6jirws_m(array, index, length5_p)
  ...
  subroutine createCol6_p(lower, upper, array)
    ...
    type(sidl_rmi_Invocation_6d), intent(out) :: array
    external In_ary_createCol3qdq7spe9ev5w_m
    call In_ary_createCol3qdq7spe9ev5w_m(6, lower, upper, array)
  ...
  subroutine createRow6_p(lower, upper, array)
    ...
    type(sidl_rmi_Invocation_6d), intent(out) :: array
    external In_ary_createRownd0omqsr6wm_j_m
    call In_ary_createRownd0omqsr6wm_j_m(6, lower, upper, array)
  end subroutine createRow6_p

  subroutine copy6_p(src, dest)
    type(sidl_rmi_Invocation_6d), intent(in) :: src
    type(sidl_rmi_Invocation_6d), intent(in) :: dest
    external Invocat_ary_copy6is8v0fon1aju_m
    call Invocat_ary_copy6is8v0fon1aju_m(src, dest)
  ...
  subroutine ensure6_p(src, dim, ordering, result)
    type(sidl_rmi_Invocation_6d), intent(in)  :: src
    type(sidl_rmi_Invocation_6d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Invoc_ary_ensurepwvlq28_wpqdd_m
    call Invoc_ary_ensurepwvlq28_wpqdd_m(src, 6, ordering, result)
  ...
  subroutine slice66_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Invoca_ary_slicee8_5r91_55rr4_m
    call Invoca_ary_slicee8_5r91_55rr4_m(src, 6, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice66_p

  subroutine getg6_p(array, index, value)
    type(sidl_rmi_Invocation_6d), intent(in)  :: array
  ...
  subroutine get6_p(array, &
    ...
    type(sidl_rmi_Invocation_t), intent(out) :: value
    external Invocat_ary_get646himws8czccr_m
    call Invocat_ary_get646himws8czccr_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set6_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i6
    type(sidl_rmi_Invocation_t), intent(in) :: value
    external Invocat_ary_set6whkxwsisvu1g2_m
    call Invocat_ary_set6whkxwsisvu1g2_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy6_p(src, dest)
    type(sidl_rmi_Invocation_6d), intent(in) :: src
    type(sidl_rmi_Invocation_6d), intent(out) :: dest
    integer(sidl_int) :: dim
    external In_ary_smartCopyhfbxfo3asgjc3_m
    dim = 6
    call In_ary_smartCopyhfbxfo3asgjc3_m(src, 6, dest)
  end subroutine smartCopy6_p

  logical function  isColumnOrder6_p(array)
    type(sidl_rmi_Invocation_6d), intent(in)  :: array
    external ary_isColumnOrderro74_61krayb_m
    call ary_isColumnOrderro74_61krayb_m(array, isColumnOrder6_p)
  end function isColumnOrder6_p

  logical function  isRowOrder6_p(array)
    type(sidl_rmi_Invocation_6d), intent(in)  :: array
    external I_ary_isRowOrderwrkl6jm2zx45k_m
    call I_ary_isRowOrderwrkl6jm2zx45k_m(array, isRowOrder6_p)
  end function isRowOrder6_p

  integer (kind=sidl_int) function  dimen6_p(array)
    type(sidl_rmi_Invocation_6d), intent(in)  :: array
    external Invoca_ary_dimene7j0yj1dohhyb_m
    call Invoca_ary_dimene7j0yj1dohhyb_m(array, dimen6_p)
  ...
  integer (kind=sidl_int) function  stride6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoc_ary_stride_osjbpdtqgbr3_m
    call Invoc_ary_stride_osjbpdtqgbr3_m(array, index, stride6_p)
  ...
  integer (kind=sidl_int) function  lower6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoca_ary_lowerpvxk5v7667bo8_m
    call Invoca_ary_lowerpvxk5v7667bo8_m(array, index, lower6_p)
  ...
  integer (kind=sidl_int) function  upper6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoca_ary_upperic2bd00apk096_m
    call Invoca_ary_upperic2bd00apk096_m(array, index, upper6_p)
  ...
  integer (kind=sidl_int) function  length6_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoc_ary_lengthtioowgh6jirws_m
    call Invoc_ary_lengthtioowgh6jirws_m(array, index, length6_p)
  ...
  subroutine createCol7_p(lower, upper, array)
    ...
    type(sidl_rmi_Invocation_7d), intent(out) :: array
    external In_ary_createCol3qdq7spe9ev5w_m
    call In_ary_createCol3qdq7spe9ev5w_m(7, lower, upper, array)
  ...
  subroutine createRow7_p(lower, upper, array)
    ...
    type(sidl_rmi_Invocation_7d), intent(out) :: array
    external In_ary_createRownd0omqsr6wm_j_m
    call In_ary_createRownd0omqsr6wm_j_m(7, lower, upper, array)
  end subroutine createRow7_p

  subroutine copy7_p(src, dest)
    type(sidl_rmi_Invocation_7d), intent(in) :: src
    type(sidl_rmi_Invocation_7d), intent(in) :: dest
    external Invocat_ary_copy6is8v0fon1aju_m
    call Invocat_ary_copy6is8v0fon1aju_m(src, dest)
  ...
  subroutine ensure7_p(src, dim, ordering, result)
    type(sidl_rmi_Invocation_7d), intent(in)  :: src
    type(sidl_rmi_Invocation_7d), intent(out) :: result
    integer (kind=sidl_int), intent(in) :: dim, ordering
    external Invoc_ary_ensurepwvlq28_wpqdd_m
    call Invoc_ary_ensurepwvlq28_wpqdd_m(src, 7, ordering, result)
  ...
  subroutine slice77_p(src, numElem, srcStart, srcStride, newLower, result)
    ...
    integer (kind=sidl_int), dimension(:), intent(in) :: newLower
    external Invoca_ary_slicee8_5r91_55rr4_m
    call Invoca_ary_slicee8_5r91_55rr4_m(src, 7, numElem, srcStart, srcStride, &
      newLower, result)
  end subroutine slice77_p

  subroutine getg7_p(array, index, value)
    type(sidl_rmi_Invocation_7d), intent(in)  :: array
  ...
  subroutine get7_p(array, &
    ...
    type(sidl_rmi_Invocation_t), intent(out) :: value
    external Invocat_ary_get735mk3vr5jrfxo_m
    call Invocat_ary_get735mk3vr5jrfxo_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine set7_p(array, &
    ...
    integer (kind=sidl_int), intent(in) :: i7
    type(sidl_rmi_Invocation_t), intent(in) :: value
    external Invocat_ary_set77umb9gr_xiao1_m
    call Invocat_ary_set77umb9gr_xiao1_m(array, &
      i1, &
      i2, &
      i3, &
      i4, &
  ...
  subroutine smartCopy7_p(src, dest)
    type(sidl_rmi_Invocation_7d), intent(in) :: src
    type(sidl_rmi_Invocation_7d), intent(out) :: dest
    integer(sidl_int) :: dim
    external In_ary_smartCopyhfbxfo3asgjc3_m
    dim = 7
    call In_ary_smartCopyhfbxfo3asgjc3_m(src, 7, dest)
  end subroutine smartCopy7_p

  logical function  isColumnOrder7_p(array)
    type(sidl_rmi_Invocation_7d), intent(in)  :: array
    external ary_isColumnOrderro74_61krayb_m
    call ary_isColumnOrderro74_61krayb_m(array, isColumnOrder7_p)
  end function isColumnOrder7_p

  logical function  isRowOrder7_p(array)
    type(sidl_rmi_Invocation_7d), intent(in)  :: array
    external I_ary_isRowOrderwrkl6jm2zx45k_m
    call I_ary_isRowOrderwrkl6jm2zx45k_m(array, isRowOrder7_p)
  end function isRowOrder7_p

  integer (kind=sidl_int) function  dimen7_p(array)
    type(sidl_rmi_Invocation_7d), intent(in)  :: array
    external Invoca_ary_dimene7j0yj1dohhyb_m
    call Invoca_ary_dimene7j0yj1dohhyb_m(array, dimen7_p)
  ...
  integer (kind=sidl_int) function  stride7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoc_ary_stride_osjbpdtqgbr3_m
    call Invoc_ary_stride_osjbpdtqgbr3_m(array, index, stride7_p)
  ...
  integer (kind=sidl_int) function  lower7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoca_ary_lowerpvxk5v7667bo8_m
    call Invoca_ary_lowerpvxk5v7667bo8_m(array, index, lower7_p)
  ...
  integer (kind=sidl_int) function  upper7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoca_ary_upperic2bd00apk096_m
    call Invoca_ary_upperic2bd00apk096_m(array, index, upper7_p)
  ...
  integer (kind=sidl_int) function  length7_p(array, index)
    ...
    integer (kind=sidl_int), intent(in) :: index
    external Invoc_ary_lengthtioowgh6jirws_m
    call Invoc_ary_lengthtioowgh6jirws_m(array, index, length7_p)
  ...
  subroutine castsidl_rmi_Invoca5y1ipqwsyc_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_Invocation_1d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Invoca5y1ipqwsyc_p

  subroutine castsidl_rmi_Invoca51d864af1w_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_Invocation_2d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Invoca51d864af1w_p

  subroutine castsidl_rmi_Invocawtdcsok3mz_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_Invocation_3d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Invocawtdcsok3mz_p

  subroutine castsidl_rmi_Invocafylf_5k53r_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_Invocation_4d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Invocafylf_5k53r_p

  subroutine castsidl_rmi_Invocaq8ejg28noo_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_Invocation_5d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Invocaq8ejg28noo_p

  subroutine castsidl_rmi_Invoca_jlmravytc_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_Invocation_6d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Invoca_jlmravytc_p

  subroutine castsidl_rmi_Invoca23zk6lvijg_p(oldType, newType)
    type(sidl__array), intent(out) :: newType
    type(sidl_rmi_Invocation_7d), intent(in) :: oldType
    newType%d_array = oldType%d_array
  end subroutine castsidl_rmi_Invoca23zk6lvijg_p


end module sidl_rmi_Invocation_array
