// 
// File:          sidl_LangSpecificException.cxx
// Symbol:        sidl.LangSpecificException-v0.9.15
// Symbol Type:   class
// Babel Version: 1.0.4
// Release:       $Name: V2-9-0b $
// Revision:      @(#) $Id: sidl_LangSpecificException.cxx,v 1.4 2007/09/27 19:55:45 painter Exp $
...
void
sidl::LangSpecificException::throwException0(
...
sidl::LangSpecificException::_create() {
  struct sidl_BaseInterface__object * _exception;
  ::sidl::LangSpecificException self( (*_get_ext()->createObject)(NULL,
    &_exception), false );
  if (_exception) {
...
// remote constructor
::sidl::LangSpecificException
sidl::LangSpecificException::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_LangSpecificException__remoteCreate( url.c_str(), &_exception 
    );
  if (_exception != 0 ) {
    throwException0(_exception);
  }
  return ::sidl::LangSpecificException( ior_self, false );
}

// remote connector
::sidl::LangSpecificException
sidl::LangSpecificException::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception;
  ior_self = sidl_LangSpecificException__remoteConnect( url.c_str(), 
...
// copy constructor
sidl::LangSpecificException::LangSpecificException ( const 
  ::sidl::LangSpecificException& original ) {
  d_self = (struct sidl_LangSpecificException__object*) 
    original.::sidl::LangSpecificException::_get_ior();
  if(d_self) {
...
// assignment operator
::sidl::LangSpecificException&
sidl::LangSpecificException::operator=( const ::sidl::LangSpecificException& 
  rhs ) {
  if ( d_self != rhs.d_self ) {
    ...
    d_self = (struct sidl_LangSpecificException__object*) 
      rhs.::sidl::LangSpecificException::_get_ior();
    if(d_self) {
...
sidl::LangSpecificException::LangSpecificException ( 
  ::sidl::LangSpecificException::ior_t* ior ) 
...
sidl::LangSpecificException::LangSpecificException ( 
  ::sidl::LangSpecificException::ior_t* ior, bool isWeak ) : 
...
void ::sidl::LangSpecificException::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::sidl::LangSpecificException::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
::std::string
sidl::LangSpecificException::_getURL(  )
// throws:
//       ::sidl::RuntimeException

{
  ::std::string _result;
  ior_t* const loc_self = (struct sidl_LangSpecificException__object*) 
    ::sidl::LangSpecificException::_get_ior();
  char * _local_result;
 ...
 */
void
sidl::LangSpecificException::_set_hooks( /* in */bool on )
// throws:
//       ::sidl::RuntimeException
...
struct sidl_LangSpecificException__object* sidl::LangSpecificException::_cast(
  const void* src)
{
  ior_t* cast = NULL;
  ...
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "sidl.LangSpecificException", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::sidl::LangSpecificException::ext_t * sidl::LangSpecificException::s_ext 
  = 0;

// private static method to get static data type
const ::sidl::LangSpecificException::ext_t *
sidl::LangSpecificException::_get_ext()
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
    s_ext = sidl_LangSpecificException__externals();
  }
  return s_ext;
}
