 ...
 * Revision:      @(#) $Id: sidl_SIDLException_Module.c,v 1.6 2007/09/27 19:35:27 painter Exp $
...
messages and stack traces."
  ...
  ExternalAPI[sidl_SIDLException__rmicast_NUM] = (                            \
    void*)sidl_SIDLException__rmicast;
  import_SIDLObjA();
  if (PyErr_Occurred()) {
