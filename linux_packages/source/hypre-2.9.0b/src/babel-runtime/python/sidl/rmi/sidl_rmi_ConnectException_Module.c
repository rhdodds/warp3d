 ...
 * Revision:      @(#) $Id: sidl_rmi_ConnectException_Module.c,v 1.2 2007/09/27 19:35:32 painter Exp $
...
{
  struct sidl_rmi_ConnectException__object *sidlobj;
...
attempt to connect to a remote host fails."
  ...
  ExternalAPI[sidl_rmi_ConnectException__rmicast_NUM] = (                     \
    void*)sidl_rmi_ConnectException__rmicast;
  import_SIDLObjA();
  if (PyErr_Occurred()) {
