 ...
 * Revision:      @(#) $Id: sidl_rmi_UnknownHostException_Module.c,v 1.2 2007/09/27 19:35:33 painter Exp $
...
{
  struct sidl_rmi_UnknownHostException__object *sidlobj;
...
host can not be found by a DNS lookup."
  ...
  ExternalAPI[sidl_rmi_UnknownHostException__rmicast_NUM] = (                 \
    void*)sidl_rmi_UnknownHostException__rmicast;
  import_SIDLObjA();
  if (PyErr_Occurred()) {
