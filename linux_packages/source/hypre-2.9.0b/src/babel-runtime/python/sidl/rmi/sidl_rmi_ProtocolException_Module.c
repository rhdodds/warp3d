 ...
 * Revision:      @(#) $Id: sidl_rmi_ProtocolException_Module.c,v 1.2 2007/09/27 19:35:33 painter Exp $
...
{
  struct sidl_rmi_ProtocolException__object *sidlobj;
...
This is a base class for all protocol specific exceptions."
  ...
  ExternalAPI[sidl_rmi_ProtocolException__rmicast_NUM] = (                    \
    void*)sidl_rmi_ProtocolException__rmicast;
  import_SIDLObjA();
  if (PyErr_Occurred()) {
