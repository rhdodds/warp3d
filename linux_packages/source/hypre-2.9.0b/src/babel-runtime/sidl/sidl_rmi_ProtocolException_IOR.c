 ...
 * Revision:      @(#) $Id: sidl_rmi_ProtocolException_IOR.c,v 1.2 2007/09/27 19:35:47 painter Exp $
 ...
 */
  ...
  epv->f_add                      = (void (*)(struct 
    sidl_rmi_ProtocolException__object*,const char*,int32_t,const char*,struct 
...
static struct sidl_rmi_NetworkException__epv* sidl_rmi_ProtocolException__super(
  void) {
