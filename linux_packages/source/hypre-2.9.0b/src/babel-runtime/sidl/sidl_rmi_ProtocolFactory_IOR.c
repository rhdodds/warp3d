 ...
 * Revision:      @(#) $Id: sidl_rmi_ProtocolFactory_IOR.c,v 1.6 2007/09/27 19:35:47 painter Exp $
 ...
 */
  ...
  epv->f_isSame                   = (sidl_bool (*)(struct 
    sidl_rmi_ProtocolFactory__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_rmi_ProtocolFactory__object*,const char*,struct 
...
static void
initMetadata(struct sidl_rmi_ProtocolFactory__object* self, sidl_BaseInterface* 
  _ex)
{
