...
#define LIBXML2_VERSION 2009000
#endif
...
#define LTDL_SYSSEARCHPATH "/lib:/usr/lib:/usr/lib64:include:/etc/ld.so.conf.d/i386-linux-gnu_GL.conf:/etc/ld.so.conf.d/i686-linux-gnu.conf:/etc/ld.so.conf.d/libc.conf:/etc/ld.so.conf.d/nvidia_settings.conf:/etc/ld.so.conf.d/x86_64-linux-gnu.conf:/etc/ld.so.conf.d/x86_64-linux-gnu_EGL.conf:/etc/ld.so.conf.d/x86_64-linux-gnu_GL.conf"
#endif
...
#define PYTHON_SHARED_LIBRARY "/usr/lib/x86_64-linux-gnu/libpython2.7.so"
#endif

/* Directory of the Python shared library */
#ifndef PYTHON_SHARED_LIBRARY_DIR
#define PYTHON_SHARED_LIBRARY_DIR "/usr/lib/x86_64-linux-gnu"
#endif
