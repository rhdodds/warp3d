 ...
 * Revision:      @(#) $Id: sidl_PreViolation_IOR.c,v 1.6 2007/09/27 19:35:44 painter Exp $
...
static struct sidl_PreViolation__epv s_new_epv_hooks__sidl_previolation;
 ...
 */
  ...
  struct sidl_PreViolation__epv*     hepv = &s_new_epv_hooks__sidl_previolation;
  ...
  epv->f__ctor2                   = NULL;
  epv->f__dtor                    = NULL;
  epv->f_addRef                   = (void (*)(struct sidl_PreViolation__object*,
    struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef                = (void (*)(struct sidl_PreViolation__object*,
    struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                   = (sidl_bool (*)(struct 
    sidl_PreViolation__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_PreViolation__object*,const char*,struct sidl_BaseInterface__object 
    **)) s1->f_isType;
  epv->f_getClassInfo             = (struct sidl_ClassInfo__object* (*)(struct 
    sidl_PreViolation__object*,struct sidl_BaseInterface__object **)) 
    s1->f_getClassInfo;
    ...
    sidl_PreViolation__epv **s_arg_epv_hooks__sidl_previolation)
{
  ...
  *s_arg_epv_hooks__sidl_runtimeexception = 
    &s_new_epv_hooks__sidl_runtimeexception;
  *s_arg_epv__sidl_previolation = &s_new_epv__sidl_previolation;
  *s_arg_epv_hooks__sidl_previolation = &s_new_epv_hooks__sidl_previolation;
}
/*
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  ior_sidl_PreViolation__set_hooks(s0, FALSE, _ex);
