 ...
 * Revision:      @(#) $Id: sidl_NotImplementedException_IOR.c,v 1.2 2007/09/27 19:35:44 painter Exp $
...
static struct sidl_NotImplementedException__epv 
  s_new_epv__sidl_notimplementedexception;

static struct sidl_NotImplementedException__epv 
  s_new_epv_hooks__sidl_notimplementedexception;
 ...
 */
  ...
  struct sidl_NotImplementedException__epv*  epv  = 
    &s_new_epv__sidl_notimplementedexception;
  struct sidl_NotImplementedException__epv*  hepv = 
    &s_new_epv_hooks__sidl_notimplementedexception;
  ...
  epv->f_addRef                   = (void (*)(struct 
    sidl_NotImplementedException__object*,struct sidl_BaseInterface__object 
    **)) s1->f_addRef;
  ...
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_NotImplementedException__object*,const char*,struct 
  ...
  epv->f_add                      = (void (*)(struct 
    sidl_NotImplementedException__object*,const char*,int32_t,const char*,
    struct sidl_BaseInterface__object **)) s1->f_add;
  epv->f_packObj                  = (void (*)(struct 
    sidl_NotImplementedException__object*,struct sidl_io_Serializer__object*,
    struct sidl_BaseInterface__object **)) s1->f_packObj;
  epv->f_unpackObj                = (void (*)(struct 
    sidl_NotImplementedException__object*,struct sidl_io_Deserializer__object*,
    struct sidl_BaseInterface__object **)) s1->f_unpackObj;

  sidl_NotImplementedException__set_epv(epv);

  memcpy((void*)hepv, epv, sizeof(struct sidl_NotImplementedException__epv));
...
static struct sidl_SIDLException__epv* sidl_NotImplementedException__super(
  void) {
...
static void
initMetadata(struct sidl_NotImplementedException__object* self, 
...
sidl_NotImplementedException__new(void* ddata, struct 
  sidl_BaseInterface__object ** _ex)
{
  struct sidl_NotImplementedException__object* self =
  ...
  struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv                         = &s_new_epv__sidl_notimplementedexception;

  s0->d_sidl_runtimeexception.d_object = self;

  s0->d_data = NULL;

  ior_sidl_NotImplementedException__set_hooks(s0, FALSE, _ex);
...
s_externalEntryPoints = {
  sidl_NotImplementedException__new,
  sidl_NotImplementedException__super,
  1, 
  0
};
