 ...
 * Revision:      @(#) $Id: sidl_rmi_MalformedURLException_Impl.c,v 1.2 2007/09/27 19:35:47 painter Exp $
...
struct sidl_rmi_MalformedURLException__object* 
  ...
  return sidl_rmi_MalformedURLException__connectI(url, ar, _ex);
}
struct sidl_rmi_MalformedURLException__object* 
  impl_sidl_rmi_MalformedURLException_fcast_sidl_rmi_MalformedURLException(
  void* bi, sidl_BaseInterface* _ex) {
  return sidl_rmi_MalformedURLException__cast(bi, _ex);
}
