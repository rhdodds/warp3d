 ...
 * Revision:      @(#) $Id: sidl_rmi_ConnectRegistry_IOR.c,v 1.6 2007/09/27 19:35:46 painter Exp $
 ...
 */
  ...
  epv->f_isSame                   = (sidl_bool (*)(struct 
    sidl_rmi_ConnectRegistry__object*,struct sidl_BaseInterface__object*,struct 
    sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                   = (sidl_bool (*)(struct 
    sidl_rmi_ConnectRegistry__object*,const char*,struct 
...
static void
initMetadata(struct sidl_rmi_ConnectRegistry__object* self, sidl_BaseInterface* 
  _ex)
{
