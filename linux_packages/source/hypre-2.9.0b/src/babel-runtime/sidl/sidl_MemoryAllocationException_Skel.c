...
void
sidl_MemoryAllocationException__set_epv(struct 
  sidl_MemoryAllocationException__epv *epv)
{
  epv->f__ctor = impl_sidl_MemoryAllocationException__ctor;
  epv->f__ctor2 = impl_sidl_MemoryAllocationException__ctor2;
  epv->f__dtor = impl_sidl_MemoryAllocationException__dtor;
...
void sidl_MemoryAllocationException__call_load(void) { 
...
struct sidl_MemoryAllocationException__object* 
  ...
  void* bi, sidl_BaseInterface *_ex) { 
  return 
    impl_sidl_MemoryAllocationException_fcast_sidl_MemoryAllocationException(bi,
    _ex);
}
...
struct sidl_RuntimeException__object* 
  ...
  char* url, sidl_bool ar, sidl_BaseInterface *_ex) { 
  return impl_sidl_MemoryAllocationException_fconnect_sidl_RuntimeException(url,
    ar, _ex);
}
...
sidl_MemoryAllocationException__get_data(sidl_MemoryAllocationException self)
{
  return (struct sidl_MemoryAllocationException__data*)(self ? self->d_data : 
    NULL);
}

void sidl_MemoryAllocationException__set_data(
  sidl_MemoryAllocationException self,
  struct sidl_MemoryAllocationException__data* data)
{
  if (self) {
    self->d_data = data;
  }
