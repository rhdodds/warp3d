...
c     *                       written by : asg                       *
c     *                                                              *
c     *                   last modified : rhd 4/9/2018 rhd           *
c     *                                                              *
...
c
c           do = 15: call routines that calculate displacement
c                    derivatives at model nodes and stress work
c                    density at model nodes for J-computations
c
      case( 15 )
         if(debug) write(out,'("=> Proc",i3,"do di_set_up_J7_J8")')
     &             myid
         call di_setup_J7_J8( idummy1 )
c
...
c
      case( 30 )
         ...
         call di_node_props_setup (idummy1)
c
