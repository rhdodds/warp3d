...
{
  int i, j, k, me;
  idxtype *xadj, *adjncy, *pwgts, *nptr, *nind, *etype_vec;
  int options[10], pnumflag=0, wgtflag=0;
  int nnbrs, nbrind[200], nbrwgt[200], maxpwgt;
  int esize, esizes[] = {-1, 3, 4, 8, 4};
  ...
  etype_vec = idxmalloc(*ne, "METIS_MESHPARTNODAL: etype_vec");
  ...
  METIS_MeshToDual(ne, nn, elmnts, etype_vec, &pnumflag, xadj, adjncy);
