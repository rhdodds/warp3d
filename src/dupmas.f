...
c     *                                                              *          
c     *     creates a separate copy of all element                   *          
c     *     data necessary for the mass computations of each         *          
c     *     element in a block                                       *          
c     *                                                              *          
c     ****************************************************************          
c                                                                               
...
c
      implicit none
c
      integer :: span, nnode, mxvl, totdof 
      double precision :: c(*), ce_block(mxvl,*)                                                  
...
c
      implicit none
c
      integer :: span, nnode, num_struct_nodes, mxndel
      integer :: belinc(nnode,*)                                                   
      real    :: fgm_node_values(num_struct_nodes,*)                                 
      double precision :: rho_block(mxndel,*)                                                    
c
      integer :: i, k 
c      
